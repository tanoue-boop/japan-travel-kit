      ...
      <div className={styles.content}>
        ...
        <div className={styles.verdictBox}>
          ...
          <div className={styles.verdictBody}>
            ...
            <a href="https://affiliate.klook.com/redirect?aid=119070&aff_adid=1264855&k_site=https%3A%2F%2Fwww.klook.com%2Factivity%2F1420-7-day-whole-japan-rail-pass-jr-pass%2F" className={styles.verdictBtn} target="_blank" rel="noopener noreferrer nofollow">
